...
'Credentials'
//Memanggil Data
def testData = 'Data Files/Login/testData_Login (1)'
...
//		default:
//		WebUI.comment("Test Case: Default")
//		if (username != 'none') {
//			WebUI.setText(findTestObject('Object Repository/Login Page/username_Field'), '')
//		}
//		WebUI.setText(findTestObject('Object Repository/Login Page/password_Field'), '')
//		WebUI.click(findTestObject('Object Repository/Login Page/login_Btn'))
	}
}